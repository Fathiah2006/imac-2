...
if (!function_exists('pc_customizer_defaults')) {
    ...
    function pc_customizer_defaults () {
        $default_values = array(
            ...
            'toggle_hero_header_sec'        => true,
            'hero_header_sec_img'           => get_imac_assets('img') . 'gadget.jpg',
            'hero_header_sec_title'         => __('Stay ahead of the curve with our forward thinking.', 'pure-commerce'),
            'hero_header_sec_subtext'       => __('We take extreme pride at being the very best at what we do.', 'pure-commerce'),
            'toggle_hero_header_sec_btn'    => true,
            'hero_header_sec_btn_url'       => '#',
            'hero_header_sec_btn_text'      => __('Get in touch', 'pure-commerce'),
