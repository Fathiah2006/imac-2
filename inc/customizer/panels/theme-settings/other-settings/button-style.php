...
$wp_customize->add_section(
    ...
    array(
        ...
        'description' => esc_html__('Change the style to be used for buttons on the site', 'pure-commerce'),
        'priority' => 10,
...
$wp_customize->add_setting(
    'button_style',
    array(
        'default' => $this->defaults['button_style'],
        'transport' => 'refresh',
...
$wp_customize->add_control(new Btn_Style_Custom_Control(
    ...
    'button_style',
    array(
        'label' => __('Button Style', 'pure-commerce'),
